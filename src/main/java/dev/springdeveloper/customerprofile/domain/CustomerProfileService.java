package dev.springdeveloper.customerprofile.domain;

import dev.springdeveloper.customerprofile.data.CustomerProfileEntity;
import dev.springdeveloper.customerprofile.data.CustomerProfileRepository;
